            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        {{-- Arahkan ke rute baru untuk Lifetime --}}
                        <a href="{{ route('payment.lifetime') }}"
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-2">Modul 1 Tahun</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Rp 100.000</p>
                        {{-- Arahkan ke rute baru untuk Yearly --}}
                        <a href="{{ route('payment.yearly') }}"
