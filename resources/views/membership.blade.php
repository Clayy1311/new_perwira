          ...
          <div class="slide-in-left overflow-hidden card-holder w-[400px] bg-gradient-to-r from-[#7a9ac5] via-[#052146] to-[#afd2ff] p-[1px] shadow-[0_0_15px_#367cff70]">
            <div class="card w-[100%] p-[20px] flex justify-center flex-col items-center bg-[#021028]">
              ...
              <div class="card-footer mb-[20px] flex justify-center items-center font-open-sans text-xl">
                <a href="/login">
  <button class="font-bold min-w-[68px] text-white bg-gradient-to-r from-[#528fff] to-[#07368e] px-[20px] py-[10px] rounded-[5px]">
    DAPATKAN AKSES
  </button>
</a>
<label class="flex items-center space-x-3">
    <input type="radio" name="plan" value="wolfpack">
          ...
          <div class="slide-in-right overflow-hidden card-holder w-[400px] bg-gradient-to-r from-[#f5a3ff] via-[#3b0546] to-[#a01dbf] p-[1px] shadow-[0_0_15px_#e366ff70]">
            <div class="card w-[100%] p-[20px] flex justify-center flex-col items-center bg-[#021028] exclusive">
              <div class="card-header text-center font-open-sans">
                ...
                <p class="mb-[20px] text-white bg-clip-text bg-gradient-to-r from-[#f5a3ff] to-[#a01dbf] drop-shadow-[0_0_6px_rgba(15,91,203,0.4)] leading-relaxed drop-shadow-[0_0_6px_rgba(0,0,0,0.4)] ">
                  Lifetime
                </p>
              ...
              <div class="card-footer mb-[20px] flex justify-center items-center font-open-sans text-xl">
                <button class="font-bold min-w-[68px] text-white bg-gradient-to-r from-[#da52ff] to-[#7a078e] px-[20px] py-[10px] rounded-[5px]">
                  DAPATKAN AKSES
                </button>
                <label class="flex items-center space-x-3">
                    <input type="radio" name="plan" value="eternal" checked>
      ...
      <button type="submit" class="w-full mt-6 text-white font-bold bg-gradient-to-r from-blue-500 to-blue-800 text-white px-4 py-2 rounded">
        Bayar Sekarang
    </button>
    </form>
<!-- Midtrans Snap.js -->
