<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Buat Point Baru untuk Modul: <span class="font-bold">{{ $module->name }}</span>
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.modules.points.store', $module) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @include('admin.module_points.form', ['module' => $module])
